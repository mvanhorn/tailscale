...
// then VIPService delete, then cluster cert resources.
...
// against a domain the control plane no longer recognises. Each step is
// idempotent so an interrupted reconcile resumes cleanly.
