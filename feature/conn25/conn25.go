...
var (
	metricDNSResponseRewriteErrorServfail                        = clientmetric.NewCounter("conn25_map_dns_response_rewrite_error_servfail")                           // return servfail on error rewriting response for an app connector domain
	metricDNSResponseRewriteUnsupportedQuestionTypeErrorServfail = clientmetric.NewCounter("conn25_map_dns_response_rewrite_unsupported_question_type_error_servfail") // return servfail on error rewriting empty answers to an unsupported question type for an app connector domain
)
